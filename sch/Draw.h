...
void drawVia(Layout &dst, int net, int viaLevel, vec2i axis, vec2i size=vec2i(0,0), bool expand=true, vec2i pos=vec2i(0,0), vec2i dir=vec2i(1,1));
void drawViaStack(Layout &dst, int net, int downLevel, int upLevel, vec2i axis, vec2i size=vec2i(0,0), vec2i pos=vec2i(0,0), vec2i dir=vec2i(1,1));
